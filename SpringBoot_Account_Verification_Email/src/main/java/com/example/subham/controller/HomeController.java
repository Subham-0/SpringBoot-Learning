...
import com.example.subham.repository.UserRepo;
import com.example.subham.service.UserService;
...
public class HomeController {
	...
	public String saveUser(@ModelAttribute User user, HttpSession session,HttpServletRequest request, Model m) {
